                ...
                <div class="col-lg-12">
                    <div class="bread-crumb-area-inner">
                        <div class="breadcrumb-top">
                            <a href="#">Home</a> /
                            <a class="active" href="#">Single Project</a>
                        </div>
                ...
                <div class="col-lg-7 pr--120 pr_sm--0">
                    ...
                    <div class="about-style-one-right">
                        <div class="title-style-left">
                            ...
                            <h2 class="title mt--0 mb--25 quote">Premium Projects In Kothrud</h2>
                        </div>
                        <p class="disc mb--15 rts-slide-up">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse officia voluptatibus est non ex ducimus ipsa rerum odio saepe aliquam?
                        </p>
                        <p class="disc rts-slide-up">
                            lorem2 ipsum dolor sit amet consectetur adipisicing elit. Esse officia voluptatibus est non ex ducimus ipsa rerum odio saepe aliquam?
                        </p>
                        ...
                        <div class="col-lg-3 rts-slide-up h-100">
                            ...
                            <div class="single-choose-style-two">
                                ...
                                <div class="right-content">
                                    <h6 class="title">A scenic hill near
MIT College</h6>
                                    <!-- <p class="disc">
                        ...
                        <div class="col-lg-3 rts-slide-up h-100">
                            ...
                            <div class="single-choose-style-two">
                                ...
                                <div class="right-content">
                                    <h6 class="title">Beautiful Bhavani Mata
Temple adjacent</h6>
                                    <!-- <p class="disc">
                        ...
                        <div class="col-lg-3 rts-slide-up h-100">
                            ...
                            <div class="single-choose-style-two">
                                ...
                                <div class="right-content">
                                    <h6 class="title">Lush greenery in a
populated area</h6>
                                    <!-- <p class="disc">
                        ...
                        <div class="col-lg-3 rts-slide-up h-100">
                            ...
                            <div class="single-choose-style-two">
                                ...
                                <div class="right-content">
                                    <h6 class="title">Proximity to Paud Road—
serene living</h6>
                                    <!-- s -->
                                </div>
                            </div>
    ...
    <div class="rts-service-area rts-section-gap pt-0 pt-md-5" id="floorplan">
        <div class="container">
            ...
            <div class="row g-5 mt--30 mb--50 rts-slide-up d-flex justify-content-center">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 pt-4 pt-md-0">
                    <!-- ingle srevice area start -->
                    <div class="singe-serice-style-two">
                        <a  data-bs-toggle="modal" data-bs-target="#popModel" class="thumbnail">
                            <img src="assets/images/projects/yojangandha/floorplan/floor-plans-2bhk.avif" alt="service">
                        </a>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 pt-4 pt-md-0">
                    <div class="singe-serice-style-two">
                        <a data-bs-toggle="modal" data-bs-target="#popModel" class="thumbnail">
                            <img src="assets/images/projects/yojangandha/floorplan/floor-plans--04-3bhk.avif" alt="service">
                        </a>
                        <div class="body text-center">
                ...
                <!-- <div class="col-lg-4 col-md-6 col-sm-12 pt-4 pt-md-0">
                    <div class="singe-serice-style-two">
                        <a data-bs-toggle="modal" data-bs-target="#popModel" class="thumbnail">
                            <img src="assets/images/projects/yojangandha/floorplan/floor-plans-4bhk.avif" alt="service">
                        </a>
                        <div class="body text-center">
                            <div class="wrapper text-center">
                                <div class="icon-area d-flex justify-content-center">
