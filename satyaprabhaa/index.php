                    ...
                    <div class="about-right-inner-five">
                        <div class="itle-left-style-seven-wrapper">
                            <div class="swastik-logo">
                                <img width="200" src="assets/images/logo/swastiklogo.svg" alt="logo"></div>
                            <span class="pre">
                                About Us
                            </span>
                        ...
                        <!-- <div class="short-service-small"> -->
                            ...
                            <!-- single service area end -->
                        <!-- </div> -->
                        <div class="short-contact-about-seven">
                            <!-- <div class="left-area">
                            ...
                            <a href="about.html" class="rts-read-more-circle-btn">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="counter-main-wrapper-two counter_animation pt--0">
                        ...
                        <div class="counter-single counter__anim">
                            <div class="inner">
                                <h2 class="title"><span class="counter">28</span>+</h2>
