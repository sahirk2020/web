...
$query = "INSERT INTO lead_info (name, email, mobile_no, project, requirement, source, capaignname, capaignid, capaigncity, gclid, utm_term, utm_medium, utm_adid, utm_device, utm_matchtype, utm_location, ip) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if (
   ...
   // $response = addLeadToCRM($name, $mobile, $email, $source_details);
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('support@digitaltokri.co.in', 'Satyaprabhaa | Project Brochure Download Enquiry');
    ...
    $mail->Subject = 'Satyaprabhaa  | Project Brochure Download Enquiry';
    ...
    $mail->Body    = '<h2>Enquiry Generated by</h2>
                ...
                <p>Enquire About : ' . $requirement . '</p>
                <p>Enquire Project : ' . $project . '</p>
    		    <p>Source : ' . $source . '</p>
