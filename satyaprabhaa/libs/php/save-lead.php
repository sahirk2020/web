...
$query = "INSERT INTO lead_info (name, email, mobile_no, requirement, source, capaignname, capaignid, capaigncity, gclid, utm_term, utm_medium, utm_adid, utm_device, utm_matchtype, utm_location, ip) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
