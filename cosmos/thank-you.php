...
<body>
    <div class="breadcumb-wrapper thankyou-section services-banner" data-bg-src="assets/img/bg/bg-express.webp" style="background-image: url(&quot;assets/img/bg/bg-express.webp&quot;);">
        <div class="container">
            <div class="breadcumb-content">
                ...
                <a href="index.php" class="th-btn style2">Back to Home Page</a>
            </div>
        </div>
    </div>
</body>
