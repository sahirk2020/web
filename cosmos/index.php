...
<head>
    ...
    <meta name="keywords" content="Cosmos Laundry, Laundry Service, Dry Cleaning, Premium Laundry">
...
==============================-->
    <div class="th-hero-wrapper hero-3" id="hero">
        ...
        <div class="swiper th-slider hero-slider-3" id="heroSlider3" data-slider-options='{"effect":"slide"}'>
        ...
        <div class="icon-box">
            ...
            <button data-slider-next="#heroSlider3" class="slider-arrow default"><i class="far fa-arrow-left"></i></button>
        </div>
                ...
                <div class="col-xl-6">
                    <div class="img-box3 pe-xl-3">
                        ...
                        <div class="about-shape2">
                            <img src="assets/img/shape/shape_2.png" alt="About">
                        </div>
                        ...
                        <form action="mail.php" method="POST" class="contact-form2 ajax-contact">
                            <div class="row">
                                ...
                                <div class="form-btn col-12">
                                    <button class="th-btn style2 btn-fw th-radius">Send Message</button>
                                </div>
                            </div>
