            ...
            <div class="th-mobile-menu">
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a href="home-laundry-services.html">Laundry Services</a>
                            </li>
                            <li><a href="home-dry-cleaning.html">Home Dry Cleaning</a></li>
                            <li>
                                <a href="home-laundry-dry-services.html">Laundry & Dry Services</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="blog-grid-2-columns.html">Blog Grid 02 Columns</a>
                                    </li>
                                    <li>
                                        <a href="blog-grid-3-columns.html">Blog Grid 03 Columns</a>
                                    </li>
...
==============================-->
    <header class="th-header header-layout2">
        <div class="header-top">
            <div class="container">
                <div
                    class="row justify-content-center justify-content-xl-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <p class="header-notice text-theme">
                            Welcome to Laundry Service & Dry Cleaning
                        </p>
                    </div>
                    <div class="col-auto">
                                ...
                                <ul>
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                                <a href="home-dry-cleaning.html">Home Dry Cleaning</a>
                                            </li>
                                            <li>
                                                <a href="home-laundry-dry-services.html">Laundry & Dry Services</a>
                                            </li>
