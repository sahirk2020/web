              ...
              <div class="contact-info text-center">
                ...
                <div class="media-body ">
                  ...
                  <span class="contact-info_text">
                    <a href="tel:+919284630260">+919284630260</a>
                    <!-- <a href="tel:+9156129128">+9156-129-128</a> -->
                  </span>
                </div>
              </div>
            </div>
          ...
          <form class="lead-form contact-form input-smoke ajax-contact card-shadow">
            ...
            <div class="row">
              ...
              <div class="form-btn col-12">
                <button type="button" class="submit-btn th-btn btn-fw th-radius">Send Message</button>
              </div>
            </div>
